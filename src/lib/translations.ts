export const translations = {
  en: {
    ...
    details: {
      ...
      availabilityValue: 'Late Spring/Early Summer 2026 for select bars and restaurants in NYC & Montreal',
      price: 'Price',
  ...
  fr: {
    ...
    details: {
      ...
      availabilityValue: 'Fin du printemps/début de l\'été 2026 pour certains bars et restaurants à NYC et Montréal',
      price: 'Prix',
